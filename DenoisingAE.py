...
# Uses Gin to configure its parameters
@gin.configurable
class DenoisingAE(LightningModule):
    def __init__(self, kind="v0") -> None:
        super().__init__()
        self.kind = kind
...
"""
I have to create different classes with the different versions (very ugly) due to
how Lightning works for loading a checkpoint (it needs the class instance, not the object)
"""
